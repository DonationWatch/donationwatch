...
function SidebarProvider({
  ...
  const toggleSidebar = React.useCallback(() => {
    console.log("toggleSidebar", isMobile);
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "border-sidebar-border relative w-(--sidebar-width) bg-transparent transition-[width] duration-200 ease-linear",
      ...
      <div
        ...
        className={cn(
          "border-sidebar-border fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear lg:flex",
          side === "left"
...
export const SidebarActiveMenuSubButton = ({
  children,
  activeHref,
  activeClass,
  href,
  ...props
}: { href: string; activeHref?: string; activeClass?: string } & ComponentProps<
