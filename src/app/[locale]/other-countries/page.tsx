...
Basert på vår innledende gjennomgang kan Italia, Slovenia og Bosnia-Hercegovina være enklere å integrere, fordi PDF-ene deres ser ut til å være relativt godt strukturerte.`,
  ...
  uk: {
    p0: `Ми прагнемо інтегрувати дані про пожертвування для всіх країн, де ці дані доступні в машинозчитуваному форматі.
Більшість форматів працюють для нас, включаючи JSON, CSV, HTML-таблиці та XML.
Головною перешкодою є PDF, який часто містить відскановані зображення замість тексту, який можна витягти.
Перетворення цих PDF-файлів у структуровані дані зазвичай вимагає значних ручних зусиль.`,
    h1: `Країни, які ми наразі не відстежуємо`,
    p1: `Наразі ми не відстежуємо деякі країни через те, що їхні опубліковані дані неможливо надійно проаналізувати через обмеження формату.
На основі нашого початкового огляду, Італію, Словенію та Боснію і Герцеговину може бути легше інтегрувати, оскільки їхні PDF-файли здаються відносно добре структурованими.`,
