    ...
    <NonCountryRootLayout locale={locale}>
      ...
      >
        <FunFact
          ...
          text={{
            en: 'With the 2026 Senedd elections just days away, we detected a suspicious domain (reform-uk-wales[.]com) presenting itself as a regional branch of Reform UK. The site contained Russian metadata describing Wales as "Western Britain." In a display of active evasion, the operators scrubbed the code live while we were investigating. Following our reports, major browsers blacklisted the site as a dangerous phishing threat.\n\nShortly after being flagged, the site operators pivoted, replacing deceptive newsletter forms with a bare CMS login portal—a tactic often used to bypass automated security scanners once a domain is "burned" by public exposure. As of April 23, the domain is completely offline. Technical audits confirm that the hosting provider has issued a global REFUSED status for all DNS queries, indicating that the provider administratively terminated the zone, rendering the site unreachable worldwide.',
            de: "Wenige Tage vor den Senedd-Wahlen 2026 entdeckten wir eine verdächtige Domain (reform-uk-wales[.]com), die sich als regionaler Ableger von Reform UK ausgab. Die Website enthielt russische Metadaten, die Wales als „Westbritannien“ beschrieben. In einem Akt aktiver Verschleierung löschten die Betreiber den Code live während unserer Untersuchung. Nach unseren Berichten setzten die gängigen Browser die Website als gefährliche Phishing-Drohung auf die Sperrliste.\n\nKurz nach der Kennzeichnung änderten die Betreiber ihre Taktik und ersetzten täuschende Newsletter-Formulare durch ein einfaches CMS-Anmeldeportal – eine Taktik, die häufig angewendet wird, um automatisierte Sicherheitsscanner zu umgehen, sobald eine Domain durch öffentliche Aufmerksamkeit „verbrannt“ ist. Seit dem 23. April ist die Domain vollständig offline. Technische Audits bestätigen, dass der Hosting-Provider für alle DNS-Anfragen einen globalen REFUSED-Status ausgegeben hat, was darauf hindeutet, dass der Provider die Zone administrativ beendet hat.",
            et: "Vaid mõned päevad enne 2026. aasta Seneddi valimisi tuvastasime kahtlase domeeni (reform-uk-wales[.]com), mis esitles end Reform UK piirkondliku haruna. Sait sisaldas venekeelseid metaandmeid, mis kirjeldasid Walesi kui „Lääne-Britanniat“. Aktiivse kõrvalehoidmise märgina puhastasid haldajad koodi reaalajas meie uurimise ajal. Pärast meie teateid kandsid peamised veebibrauserid saidi ohtliku kalastusründe ohuna musta nimekirja.\n\nVarsti pärast märgistamist muutsid haldajad taktikat, asendades petlikud uudiskirja vormid tühja CMS-i sisselogimisportaaliga – seda taktikat kasutatakse sageli automatiseeritud turvaskanneritest möödahiilimiseks, kui domeen on avaliku kokkupuute tõttu „põlenud“. 23. aprilli seisuga on domeen täielikult maas. Tehnilised auditid kinnitavad, et majutusteenuse pakkuja on väljastanud kõigile DNS-päringutele globaalse REFUSED-staatuse, mis viitab sellele, et teenusepakkuja lõpetas tsooni administratiivselt.",
            nl: "Met de Senedd-verkiezingen van 2026 in zicht, hebben we een verdacht domein (reform-uk-wales[.]com) gedetecteerd dat zich voordeed als een regionale afdeling van Reform UK. De site bevatte Russische metadata waarin Wales werd beschreven als „West-Brittannië”. Als uiting van actieve ontwijking wisten de beheerders de code live te wissen terwijl wij onderzoek deden. Naar aanleiding van onze meldingen hebben grote browsers de site op de zwarte lijst gezet als een gevaarlijke phishingdreiging.\n\nKort nadat de site was gemarkeerd, veranderden de beheerders van aanpak en vervingen ze misleidende nieuwsbrief-formulieren door een kaal CMS-inlogportaal – een tactiek die vaak wordt gebruikt om automatische beveiligingsscanners te omzeilen zodra een domein „verbrand” is. Sinds 23 april is het domein volledig offline. Technische audits bevestigen dat de hostingprovider een globale REFUSED-status heeft afgegeven voor alle DNS-vragen, wat aangeeft dat de provider de zone administratief heeft beëindigd.",
            cs: "Jen několik dní před volbami do Seneddu v roce 2026 jsme zachytili podezřelou doménu (reform-uk-wales[.]com), která se vydávala za regionální pobočku Reform UK. Web obsahoval ruská metadata popisující Wales jako „Západní Británii“. V rámci aktivního vyhýbání se odhalení provozovatelé během našeho vyšetřování kód živě smazali. Na základě našich zpráv zařadily hlavní prohlížeče web na černou listinu jako nebezpečnou phishingovou hrozbu.\n\nKrátce poté, co byl web označen, změnili provozovatelé taktiku a nahradili klamavé formuláře prostým přihlašovacím portálem CMS – tato taktika se často používá k obcházení automatických bezpečnostních skenerů poté, co byla doména veřejným odhalením „prozrazena“. K 23. dubnu je doména zcela offline. Technické audity potvrzují, že poskytovatel hostingu vydal pro všechny dotazy DNS globální stav REFUSED, což naznačuje, že poskytovatel administrativně ukončil zónu.",
            lv: "Tikai dažas dienas pirms 2026. gada Seneda vēlēšanām mēs konstatējām aizdomīgu domēnu (reform-uk-wales[.]com), kas uzdevās par Reform UK reģionālo nodaļu. Vietne saturēja krievu valodas metadatus, kas aprakstīja Velsu kā „Rietumbritāniju”. Aktīvas izvairīšanās nolūkā operatori mūsu izmeklēšanas laikā tiešraidē izdzēsa kodu. Pēc mūsu ziņojumiem lielākās pārlūkprogrammas iekļāva vietni melnajā sarakstā kā bīstamu pikšķerēšanas apdraudējumu.\n\nDrīz pēc tam, kad vietne tika atzīmēta, operatori mainīja taktiku, aizstājot maldinošās formas ar vienkāršu CMS pieteikšanās portālu – šī taktika bieži tiek izmantota, lai apietu automatizētos drošības skenerus, kad domēns ir „sadedzināts” publiskas atklāšanas rezultātā. Sākot ar 23. aprīli, domēns ir pilnībā bezsaistē. Tehniskie auditi apstiprina, ka mitināšanas pakalpojumu sniedzējs visiem DNS pieprasījumiem ir piešķīris globālu REFUSED statusu, kas norāda, ka pakalpojumu sniedzējs administratīvi pārtrauca zonu.",
            hr: "Samo nekoliko dana prije izbora za Senedd 2026., otkrili smo sumnjivu domenu (reform-uk-wales[.]com) koja se predstavljala kao regionalni ogranak stranke Reform UK. Stranica je sadržavala ruske metapodatke koji opisuju Wales kao „Zapadnu Britaniju”. U činu aktivnog izbjegavanja, operateri su izbrisali kôd uživo dok smo provodili istragu. Nakon naših prijava, glavni preglednici stavili su web stranicu na crnu listu kao opasnu phishing prijetnju.\n\nUbrzo nakon što je stranica označena, operateri su promijenili taktiku, zamijenivši obmanjujuće obrasce jednostavnim CMS portalom za prijavu – taktika koja se često koristi za zaobilaženje automatskih sigurnosnih skenera nakon što je domena „razotkrivena”. Od 23. travnja domena je potpuno izvan mreže. Tehničke revizije potvrđuju da je pružatelj usluga udomljavanja izdao globalni status REFUSED za sve DNS upite, što ukazuje na to da je pružatelj administrativno ugasio zonu.",
            no: "Med bare dager igjen til Senedd-valget i 2026, oppdaget vi et mistenkelig domene (reform-uk-wales[.]com) som utga seg for å være en regional avdeling av Reform UK. Nettstedet inneholdt russiske metadata som beskrev Wales som «Vest-Britannia». I et forsøk på aktiv unndragelse slettet operatørene koden direkte mens vi etterforsket. Etter våre rapporter har store nettlesere svartelistet nettstedet som en farlig phishing-trussel.\n\nKort tid etter å ha blitt flagget, endret operatørene taktikk og erstattet villedende nyhetsbrev-skjemaer med en enkel CMS-innloggingsportal – en taktikk som ofte brukes for å omgå automatiserte sikkerhetsskannere når et domene er blitt «avslørt». Per 23. april er domenet helt nede. Tekniske revisjoner bekrefter at hostingleverandøren har utstedt en global REFUSED-status for alle DNS-forespørsler, noe som indikerer at leverandøren administrativt har avsluttet sonen.",
            uk: "За лічені дні до виборів до Сенедду 2026 року ми виявили підозрілий домен (reform-uk-wales[.]com), який видавав себе за регіональне відділення партії Reform UK. Сайт містив російські метадані, що описували Уельс як «Західну Британію». Проявляючи активне ухилення, оператори видалили код у прямому ефірі, поки ми проводили розслідування. Після наших звітів основні браузери внесли сайт до чорного списку як небезпечну фішингову загрозу.\n\nНевдовзі після того, як сайт було позначено, оператори змінили тактику, замінивши оманливі форми простим порталом входу в CMS — ця тактика часто використовується для обходу автоматизованих сканерів безпеки, коли домен стає «скомпрометованим». Станом на 23 квітня домен повністю не працює. Технічний аудит підтверджує, що хостинг-провайдер видав глобальний статус REFUSED для всіх DNS-запитів, що свідчить про адміністративне закриття зони провайдером.",
            fr: "À quelques jours des élections du Senedd de 2026, nous avons détecté un domaine suspect (reform-uk-wales[.]com) se présentant comme une branche régionale de Reform UK. Le site contenait des métadonnées russes décrivant le Pays de Galles comme la « Bretagne occidentale ». Dans une tentative d'évasion active, les opérateurs ont effacé le code en direct pendant que nous enquêtions. Suite à nos rapports, les principaux navigateurs ont mis le site sur liste noire en tant que menace de phishing dangereuse.\n\nPeu de temps après avoir été signalé, les opérateurs du site ont changé de stratégie, remplaçant les formulaires trompeurs par un simple portail de connexion CMS — une tactique souvent utilisée pour contourner les scanners de sécurité automatisés une fois qu'un domaine est « grillé ». Depuis le 23 avril, le domaine est complètement hors ligne. Des audits techniques confirment que l'hébergeur a émis un statut REFUSED mondial pour toutes les requêtes DNS, indiquant que le fournisseur a mis fin administrativement à la zone.",
          }}
        >
